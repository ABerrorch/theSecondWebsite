...
) ENGINE=MyISAM AUTO_INCREMENT=165 DEFAULT CHARSET=utf8 COMMENT='这里是用来存储文件的数据库';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-09-06 14:47:01
